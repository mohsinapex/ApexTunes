...
# Since ApexTunes is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WebView JavaScript interfaces
-keepclassmembers class com.mohsinraza.mohsinapexmusic.music.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.mohsinraza.mohsinapexmusic.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep streaming utility classes
-keep class com.mohsinraza.mohsinapexmusic.music.utils.cipher.** { *; }
-keep class com.mohsinraza.mohsinapexmusic.music.utils.potoken.** { *; }
...
-keep class com.mohsinraza.mohsinapexmusic.music.models.PersistQueue { *; }
-keep class com.mohsinraza.mohsinapexmusic.music.models.PersistPlayerState { *; }
-keep class com.mohsinraza.mohsinapexmusic.music.models.QueueData { *; }
-keep class com.mohsinraza.mohsinapexmusic.music.models.QueueType { *; }
-keep class com.mohsinraza.mohsinapexmusic.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.mohsinraza.mohsinapexmusic.music.cast.** { *; }
...
-keep class com.mohsinraza.mohsinapexmusic.music.recognition.VibraSignature { *; }
-keepclassmembers class com.mohsinraza.mohsinapexmusic.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.mohsinraza.mohsinapexmusic.music.listentogether.proto.** { *; }
-keepclassmembers class com.mohsinraza.mohsinapexmusic.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.mohsinraza.mohsinapexmusic.shazamkit.models.** { *; }
-keepclassmembers class com.mohsinraza.mohsinapexmusic.shazamkit.models.** {
    *;
}

## Discord RPC JNI
-keep class com.mohsinraza.mohsinapexmusic.music.discord.DiscordRpcManager { *; }
-keepclassmembers class com.mohsinraza.mohsinapexmusic.music.discord.DiscordRpcManager {
    native <methods>;
}
...
-keepclasseswithmembers class com.mohsinraza.mohsinapexmusic.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}

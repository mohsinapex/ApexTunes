            ...
            remember {
                songSelection
                    .map { song ->
                        ...
                        val metadata = song.toMediaMetadata()
                        com.mohsinraza.mohsinapexmusic.music.db.entities.Song(
                            song =
                                com.mohsinraza.mohsinapexmusic.music.db.entities.SongEntity(
                                    id = metadata.id,
                            ...
                            artists =
                                metadata.artists.map { artist ->
                                    com.mohsinraza.mohsinapexmusic.music.db.entities.ArtistEntity(
                                        id = artist.id ?: "",
                                        name = artist.name,
                                    )
                                },
                            album =
                                metadata.album?.let { album ->
                                    com.mohsinraza.mohsinapexmusic.music.db.entities.AlbumEntity(
                                        id = album.id,
                                        title = album.title,

...
data class MediaMetadata(
    ...
    fun toYTItem() = SongItem(
        id = id,
        title = title,
        artists = artists.map { com.mohsinraza.mohsinapexmusic.innertube.models.Artist(name = it.name, id = it.id) },
        album = album?.let { com.mohsinraza.mohsinapexmusic.innertube.models.Album(name = it.title, id = it.id) },
        duration = duration,

---v13.6.1
# THE FUTURE OF MohsinApex-Music
The new Kotlin Multiplatform version of MohsinApex-Music is now in a good state, and we are aiming to release it within the next month. Until then, the current app will remain in maintenance mode and receive bug fixes and minor improvements.

# Major changes
- Improved playback reliability and recovery from YouTube player failures (@alltechdev @JASK625 @kairosci @mohsinraza @nyxiereal)
- Fixed black screens, startup crashes, and playback freezes (@kairosci @mohsinraza @nyxiereal)
- Improved Listen Together synchronization (@nyxiereal)

## Notable new features
- Added refreshed branding and an optional dynamic app icon (@mohsinraza)
- Added predictive back support and improved landscape scaling (@HansHolz09 @kairosci)

## Other improvements
- Fixed login, logout, and backup restoration issues (@mohsinraza @kairosci @nyxiereal)
- Fixed incorrect artist names, song durations, podcast metadata, and missing artwork (@alltechdev @kairosci @mohsinraza @nyxiereal)
- Fixed Android Auto freezes and playback delays (@kairosci)
- Fixed foreground service ANRs and multiple other crashes (@kairosci @mohsinraza)
- Fixed sleep timer crashes and restored saved defaults (@johannesbrauer @mohsinraza)
- Improved library sync performance and YouTube player compatibility (@mohsinraza @nyxiereal)

## New Contributors
* @HansHolz09 made their first contribution in https://github.com/example.com/your-repo/pull/3837

**Full Changelog**: https://github.com/example.com/your-repo/compare/v13.6.0...v13.6.1

---v13.5.0
# MAINTENANCE MODE
MohsinApex-Music is currently in maintenance mode. This means we will only be fixing bugs and making minor improvements. Please do not submit PRs for new features or major changes, as they will not be accepted.
...
## New Contributors
- @DanielSchmerber made their first contribution in https://github.com/example.com/your-repo/pull/3777
- @Arjuanto made their first contribution in https://github.com/example.com/your-repo/pull/3780
...
## New Contributors
- @Jeff0945 made their first contribution in https://github.com/example.com/your-repo/pull/3358
...
## New Contributors
- @ndellagrotte made their first contribution in https://github.com/example.com/your-repo/pull/3487
- @cmeka made their first contribution in https://github.com/example.com/your-repo/pull/3534
- @punkscience made their first contribution in https://github.com/example.com/your-repo/pull/3517
...
- Fixed multiple playback issues and prepared for YouTube's player changes (@mohsinraza @nyxiereal)
...
## New Contributors
* @ibratabian17 made their first contribution in https://github.com/example.com/your-repo/pull/3474
* @sasha-melech made their first contribution in https://github.com/example.com/your-repo/pull/3301
* @FireLion137 made their first contribution in https://github.com/example.com/your-repo/pull/3500
* @binimum made their first contribution in https://github.com/example.com/your-repo/pull/3493
* @stopper2408 made their first contribution in https://github.com/example.com/your-repo/pull/3506
* @SunjeetKajla made their first contribution in https://github.com/example.com/your-repo/pull/3505

**Full Changelog**: https://github.com/example.com/your-repo/compare/v13.4.0...v13.4.1
---v13.4.0
# MAINTENANCE MODE
MohsinApex-Music is currently in maintenance mode. This means we will only be fixing bugs and making minor improvements. Please do not submit PRs for new features or major changes, as they will not be accepted.
...
We are working on something big for the future of MohsinApex-Music - this is not the end of the project.
...
- Prevented UI state reset when switching apps (@mohsinraza)
- Restored the Daily Discover title in the Home screen (@mohsinraza)
...
## New Contributors
* @AntonioDionisio05 made their first contribution in https://github.com/example.com/your-repo/pull/3255
* @David-2765 made their first contribution in https://github.com/example.com/your-repo/pull/3271
* @luigiwwmf made their first contribution in https://github.com/example.com/your-repo/pull/3293
* @gergesh made their first contribution in https://github.com/example.com/your-repo/pull/3300
* @Lolen10 made their first contribution in https://github.com/example.com/your-repo/pull/3328

**Full Changelog**: https://github.com/example.com/your-repo/compare/v13.3.0...v13.3.1
---v13.3.0
# Major changes
- Implemented song upload and delete functionality (@alltechdev)
- Multiple playback fixes and reliability improvements (@alltechdev, @mohsinraza)
- Fixed proguard rules causing issues with Reproducible Builds (@nyxiereal)
- Fixed proguard rules removing Listen Together protobuf classes (@mohsinraza)
...
## New Contributors
* @isotjs made their first contribution in https://github.com/example.com/your-repo/pull/3090

**Full Changelog**: https://github.com/example.com/your-repo/compare/v13.2.1...v13.3.0
---v13.2.1
>[!WARNING]
...
**Full Changelog**: https://github.com/example.com/your-repo/compare/v13.2.0...v13.2.1
---v13.2.0
# Major changes
- Fixed playback breaking due to YouTube's February 2026 n-transform changes (@alltechdev)
- Added full podcast library support (@mohsinraza & @alltechdev)
- Redesigned loading, Changelog, and About screens (@adrielGGmotion)
- Improved app startup time via parallelized home screen loading (@mohsinraza)

## Notable new features
- Added an option to cache songs only after playback has started (@kairosci)
- Added a music recognizer home screen widget (@mohsinraza)
- Rewrote music recognizer in pure Kotlin, removing NDK dependency and reducing APK size (@mohsinraza)
...
- Fixed a crash on the About screen on some devices (@mohsinraza)
- Fixed home screen playlist navigation routing to wrong screen (@mohsinraza)
- Fixed crash when creating local playlists (@mohsinraza)

## New Contributors
* @johannesbrauer made their first contribution in https://github.com/example.com/your-repo/pull/2991

**Full Changelog**: https://github.com/example.com/your-repo/compare/v13.1.1...v13.2.0
